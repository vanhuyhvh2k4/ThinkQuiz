    ...
    public partial class AssignmentCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentClassIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentClassIds_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentSubmittionIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentSubmittionIds_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentClassIds_AssignmentId",
                table: "AssignmentClassIds",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmittionIds_AssignmentId",
                table: "AssignmentSubmittionIds",
                column: "AssignmentId");
        }
